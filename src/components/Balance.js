...
function Balance() {
  const[realBalance,setRealBalance]=useState(1872);
  const[expense,setExpense]=useState(22578);

  const handleChange = () => {
    setRealBalance(realBalance+500);
    setExpense(expense+realBalance);
  }
          ...
          <div className="bg-gray-100  w-full flex flex-col items-center  h-80 p-5 rounded-2xl  ">
            ...
            <div className="h-40 w-40 text-center mb-5 flex flex-col items-center ml-6 justify-center rounded-full border-[20px] border-r-[#09C0D6] border-t-white -[#09C0D6] border-l-indigo-700">
              <div className="flex">
                ...
                <h1 className="text-3xl"> {realBalance}.00
                </h1>
              </div>
      ...
      <div className="mb-10 flex justify-between">
        <div>
          ...
          <div className="flex gap-6">
            <div onClick={()=>handleChange()} className="bg-[#F1F5FC] px-6 py-8 rounded-2xl cursor-pointer">
      ...
      <div className="flex gap-7">
        ...
        <div className=" p-7 rounded-xl  ">
          ...
          <div className="flex gap-5 items-center mb-5">
            ...
            <div className="cn">
              <h1 className="text-xl font-bold">${expense}.00</h1>
